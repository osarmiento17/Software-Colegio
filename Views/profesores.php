...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="display-4">Gesti&oacute;n de profesores</h1>
            </div>
        </div>
        <br>
        <div class="row justify-content-end pr-2">
            <div class="col-xs-3 offset-sm-9 offset-md-9 offset-lg-9">
                <button class="btn btn-success" id="btnCrearCurso"><i class="fas fa-plus"></i> Nuevo profesor</button>
            </div>
        </div>
        <br><br>
        <div class="row">
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><i class="fas fa-user-shield"></i> Cargo</th>
                ...
                <tr>
                    <td>Jaime Correa</td>
                    <td class="text-center"><span class="badge badge-dark">Coordinador</span></td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td class="text-center"><span class="badge badge-info">Licenciado</span></td>
                    <td class="text-right">
                        <button class="btn btn-primary btnActualizarCurso">
                            <i class="fas fa-edit"></i>
                        </button>
